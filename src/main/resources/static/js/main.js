$(function () {
    ...
    $(".mo_sch_btn").click(function () {
        ...
        $(".mo_sch_btn").toggleClass("on");
        $(".mo_search_box > a").toggleClass("on");
    });

    //mo_menu_btn event
    $(".mo_nav_btn").click(function () {
        $(".mo_menu_back").stop().fadeIn();
        $(".mo_menu_inner").addClass("on");
    });
    $(".m_close_btn").click(function () {
        $(".mo_menu_back").stop().fadeOut();
        $(".mo_menu_inner").removeClass("on");
    });

    $(".m_main_menu > li").click(function () {
        $(".m_main_menu > li").find(".m_sub_menu").stop().slideUp();
        $(this).find(".m_sub_menu").stop().slideToggle();
    });
